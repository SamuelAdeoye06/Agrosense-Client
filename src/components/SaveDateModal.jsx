                ...
                {isFutureForecast && (
                    <div className="modal-future-disclaimer">
                        ...
                        <p className="modal-future-disclaimer-text">
                            <strong>Forecast precision upgrades automatically.</strong> This date currently shows daily averages. Once it's within 48 hours, AgroSense will unlock precise hour-by-hour timing analysis — showing exactly when rain, wind and heat are expected during the day.
                        </p>
                    </div>
                )}
